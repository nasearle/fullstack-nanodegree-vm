...
menuItem2 = MenuItem(user_id=1, name="Veggie Burger",
                     ...
                     price="$7.50", course="Entree", image="",
...
menuItem1 = MenuItem(user_id=1, name="French Fries",
                     ...
                     price="$2.99", course="Appetizer", image="",
                     restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1, name="Chicken Burger", description="Juicy"
                     ...
                     price="$5.50", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem3 = MenuItem(user_id=1, name="Chocolate Cake", description="fresh"
                     ...
                     price="$3.99", course="Dessert", image="",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Sirloin Burger", description="Made"
                                                   " with grade A beef",
                     price="$7.99", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem5 = MenuItem(user_id=1, name="Root Beer", description="16oz of "
                                                  "refreshing goodness",
                     price="$1.99", course="Beverage", image="",
                     restaurant=restaurant1)
...
menuItem6 = MenuItem(user_id=1, name="Iced Tea", description="with Lemon",
                     price="$.99", course="Beverage", image="",
                     restaurant=restaurant1)
...
menuItem7 = MenuItem(user_id=1, name="Grilled Cheese Sandwich",
                     ...
                     price="$3.49", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem8 = MenuItem(user_id=1, name="Veggie Burger", description="Made with "
                     ...
                     price="$5.99", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem3 = MenuItem(user_id=1, name="Spicy Tuna Roll", description="Seared"
            " rare ahi, avocado, edamame, cucumber with wasabi soy sauce ",
             price="15", course="Entree", image="", restaurant=restaurant2)
...
menuItem5 = MenuItem(user_id=1, name="Beef Noodle Soup", description="A "
                     "Chinese noodle soup made of stewed or red braised beef,"
                    " beef broth, vegetables and Chinese noodles.",
                     price="14", course="Entree", image="",
                     restaurant=restaurant2)
...
menuItem6 = MenuItem(user_id=1, name="Ramen", description="a Japanese noodle"
            " soup dish. It consists of Chinese-style wheat noodles served in"
            " a meat- or (occasionally) fish-based broth, often flavored with"
            " soy sauce or miso, and uses toppings such as sliced pork, dried"
            " seaweed, kamaboko, and green onions.",
            price="12", course="Entree", image="", restaurant=restaurant2)
...
menuItem1 = MenuItem(user_id=1, name="Pho", description="a Vietnamese noodle"
                    ...
                    " called banh pho, a few herbs, and meat.", price="$8.99",
                     course="Entree", image="", restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1, name="Chinese Dumplings", description="a "
                    ...
                    "minced meat and finely chopped vegetables wrapped into"
                    " a piece of dough skin. The skin can be either thin and"
                    " elastic or thicker.", price="$6.99", course="Appetizer",
                    image="", restaurant=restaurant1)

session.add(menuItem2)
session.commit()

menuItem3 = MenuItem(user_id=1, name="Gyoza", description="light seasoning of"
                    " Japanese gyoza with salt and soy sauce, and in a thin "
                    "gyoza wrapper", price="$9.95", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Stinky Tofu", description="Taiwanese "
            ...
            price="$6.99", course="Entree", image="", restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1, name="Veggie Burger", description="Juicy "
                     ...
                     price="$9.50", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Tres Leches Cake", description="Rich,"
                    " luscious sponge cake soaked in sweet milk and topped "
                    "with vanilla bean whipped cream and strawberries.",
                     price="$2.99", course="Dessert", image="",
                     restaurant=restaurant1)

session.add(menuItem1)
session.commit()

menuItem2 = MenuItem(user_id=1, name="Mushroom risotto", description="Port"
                    "abello mushrooms in a creamy risotto", price="$5.99",
                     course="Entree", image="", restaurant=restaurant1)
...
menuItem3 = MenuItem(user_id=1, name="Honey Boba Shaved Snow",
                    ...
                    " made mochi", price="$4.50", course="Dessert", image="",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Cauliflower Manchurian", description=
                "Golden fried cauliflower florets in a midly spiced soya, "
                "garlic sauce cooked with fresh cilantro, celery, chilies, "
                "ginger & green onions", price="$6.95", course="Appetizer",
                image="", restaurant=restaurant1)
...
menuItem5 = MenuItem(user_id=1, name="Aloo Gobi Burrito", description="Vegan "
                    "goodness. Burrito filled with rice, garbanzo beans, "
                    "curry sauce, potatoes (aloo), fried cauliflower (gobi) "
                    "and chutney. Nom Nom", price="$7.95", course="Entree",
                     image="", restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1, name="Veggie Burger", description="Juicy"
                    " grilled veggie patty with tomato mayo and lettuce",
                     price="$6.80", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Shellfish Tower", description="Lobster,"
                    " shrimp, sea snails, crawfish, stacked into a delicious"
                    " tower", price="$13.95", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1, name="Chicken and Rice", description="Chicken"
                    "... and rice", price="$4.95", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem3 = MenuItem(user_id=1, name="Mom's Spaghetti", description=
                    "Spaghetti with some incredible tomato sauce made by mom",
                     price="$6.95", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Choc Full O\' Mint (Smitten\'s Fresh "
                    "Mint Chip ice cream)", description="Milk, cream, salt,"
                    " ..., Liquid nitrogen magic", price="$3.95",
                     course="Dessert", image="", restaurant=restaurant1)
...
menuItem5 = MenuItem(user_id=1, name="Tonkatsu Ramen", description="Noodles"
                    " in a delicious pork-based broth with a soft-boiled egg",
                     price="$7.95", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Lamb Curry", description="Slow cook "
                    "that thang in a pool of tomatoes, onions and allll those"
                    " tasty Indian spices. Mmmm.", price="$9.95",
                     course="Entree", image="", restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1, name="Chicken Marsala", description="Chicken"
                " cooked in Marsala wine sauce with mushrooms", price="$7.95",
                     course="Entree", image="", restaurant=restaurant1)
...
menuItem3 = MenuItem(user_id=1, name="Potstickers", description="Delicious"
                    " chicken and veggies encapsulated in fried dough.",
                     price="$6.50", course="Appetizer", image="",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Nigiri Sampler", description="Maguro,"
                    " Sake, Hamachi, Unagi, Uni, TORO!", price="$6.75",
                     course="Appetizer", image="", restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1, name="Veggie Burger", description="Juicy "
                    "grilled veggie patty with tomato mayo and lettuce",
                     price="$7.00", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Boysenberry Sorbet", description="An "
                    ...
                    "frozen (and seedless) awesomeness", price="$2.99",
                     course="Dessert", image="", restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1, name="Broiled salmon", description="Salmon "
                "fillet marinated with fresh herbs and broiled hot & fast",
                     price="$10.95", course="Entree", image="",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken", description="Chicken"
                    ...
                    " burning charcoal.", price="$8.95", course="Entree",
                     image="", restaurant=restaurant1)
...
menuItem10 = MenuItem(user_id=1, name="Spinach Ice Cream", description=
                    "vanilla ice cream made with organic spinach leaves",
                      price="$1.99", course="Dessert", image="",
                      restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Chantrelle Toast", description="Crispy"
                    ...
                    "chantrelle mushrooms", price="$5.95", course="Appetizer",
                     image="", restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Lemon Curd Ice Cream Sandwich",
                    ...
                    "chocolate macaron with cardamom meringue and cashews",
                     price="$4.25", course="Dessert", image="",
                     restaurant=restaurant1)
